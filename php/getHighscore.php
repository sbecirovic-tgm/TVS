...
function getAwardHighscoreProSaison( $saisonNummer )
{
    ...
    {
        $sKuerzel = $schuelerArray['kuerzel'];
        $sqlC2 = "select skuerzel from auszeichnung where saisonNummer = '$saisonNummer' and skuerzel = '$sKuerzel' order by skuerzel ";
    ...
    $sqlC2 = "select skuerzel from auszeichnung where saisonNummer = '$saisonNummer' order by skuerzel ";
